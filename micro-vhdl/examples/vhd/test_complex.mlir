hw.module private @processor_core<DATA_WIDTH: i32 = 16>(in %clk: !seq.clock, in %reset: i1, in %en: i1, in %opcode: i2, in %operandA: i1, in %operandB: i1, out result: i1) {
  ...
  %reg_out = seq.compreg %37, %clk initial %38 : i1
  %43 = seq.initial () {
    %44 = hw.constant 0 : i1
    seq.yield %44 : i1
  } : () -> !seq.immutable<i1>
  %45 = seq.compreg %reset, %clk initial %43 : i1
  %46 = hw.constant -1 : i1
  %47 = comb.xor %45, %46 : i1
  %40 = comb.or %47, %is_zero : i1
  %50 = seq.initial () {
    %51 = hw.constant 0 : i1
    seq.yield %51 : i1
  } : () -> !seq.immutable<i1>
  %52 = seq.compreg %clk, %clk initial %50 : i1
  %48 = comb.icmp eq %clk, %52 : i1
  %53 = comb.and %40, %48 : i1
  verif.assert %53 : i1
...
hw.module @system_top(in %sys_clk: i1, in %sys_rst: i1, in %sys_en: i1, in %opA_0: i32, in %opB_0: i32, in %opA_1: i32, in %opB_1: i32, out out_0: i32, out out_1: i32) {
  // --- Body ---
  %57 = hw.constant 0 : i2
  %out_0 = hw.instance "core_0" @processor_core<DATA_WIDTH: i32 = 32>(clk: %sys_clk: !seq.clock, reset: %sys_rst: i1, en: %sys_en: i1, opcode: %57: i2, operandA: %opA_0: i1, operandB: %opB_0: i1) -> (result: i1)
  %63 = hw.constant 2 : i2
  %out_1 = hw.instance "core_1" @processor_core<DATA_WIDTH: i32 = 32>(clk: %sys_clk: !seq.clock, reset: %sys_rst: i1, en: %sys_en: i1, opcode: %63: i2, operandA: %opA_1: i1, operandB: %opB_1: i1) -> (result: i1)
